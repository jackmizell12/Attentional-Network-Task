...
function practice_instrRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of practice_instrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function pract_trialRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of pract_trialComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function MainTrialInstructRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of MainTrialInstructComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function post_fixation_2RoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of post_fixation_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
